export default {
  ...
  colors: {
    ...
    danger: '#FF0000',
    primary: '#5B9F4E', // primary button and link color
    secondary: '#5B9F4E', // secondary color - can be used for hover states
  ...
  buttons: {
    ...
    defaultBtn: {
      ...
      padding: ['18px 30px', null, '20px 40px'],
      fontFamily: 'body',
      cursor: 'pointer',
      lineHeight: 1.2,
    ...
    primary: {
      ...
      bg: 'primary',
      '&:hover': {
        boxShadow: 'rgba(189, 219, 115, 0.89) 0px 9px 20px -5px',
      },
    },
    whiteButton: {
      variant: 'buttons.defaultBtn',
